 ...
 * Created by bandaray
 */
public class S01ChangeNahChildListFragment extends Fragment implements FragmentWizard {
     ...
     */
    public static S01ChangeNahChildListFragment newInstance(int index) {
        S01ChangeNahChildListFragment fragment = new S01ChangeNahChildListFragment();
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        adapter = new SelectChildArrayAdapter(context, childItems, ChildListType.CHANGE_NAH);
    ...
    private void setSelectedChildList() {
        ...
        ServiceChangeNah changeNah = app.getServiceChangeNah();
        if (changeNah != null) {
        ...
        app.setServiceChangeNah(new ServiceChangeNah(selectedChildList, selectedChildIdList));
    }
    ...
    private void executeGetChildListAsyncTask() {
        ...
        ServicesGetChildListItemsTask asyncTask = new ServicesGetChildListItemsTask(
                context, ServiceAppType.CHANGE_NAH,
