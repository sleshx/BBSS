 ...
 */
public class TransferPseaFragmentContainerActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        app.setServiceTransferToPsea(new ServiceTransferToPsea());
    ...
    private List<Fragment> getFamilyViewWizardPages() {
        ...
        fragments.add(S01TransferPseaChildListFragment.newInstance(0));
        fragments.add(S02TransferPseaBankDeclarationFragment.newInstance(1));
        return fragments;
    }
    ...
    public void setFragmentTitle(View rootView) {
        helper.setFragmentTitle(rootView, R.string.title_activity_services_cda_psea);
    }
    ...
    public void setInstructions(View rootView, int currentPageNo, int descriptionStringId,
        ...
        helper.setFragmentInstructions(rootView, currentPageNo,
                R.string.desc_services_transfer_psea_instruction_title, descriptionStringId,
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!current.onPauseFragment(isValidationRequired)) {
                    ...
                    if (currentPosition == 4 && !app.getServiceTransferToPsea().isThirdParty()) {
        ...
        nextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!current.onPauseFragment(isValidationRequired)) {
                    ...
                    if (currentPosition == 1 && !app.getServiceTransferToPsea().isThirdParty()) {
                        jumpToPageWithIndex(currentPosition + 3);
                    } else {
                        jumpToPageWithIndex(currentPosition + 1);
                    }
