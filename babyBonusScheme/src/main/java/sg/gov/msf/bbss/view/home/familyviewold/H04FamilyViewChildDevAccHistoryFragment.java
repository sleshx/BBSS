 ...
 */
public class H04FamilyViewChildDevAccHistoryFragment extends Fragment implements FragmentWizard {
     ...
     */
    public static H04FamilyViewChildDevAccHistoryFragment newInstance(int index) {
        H04FamilyViewChildDevAccHistoryFragment fragment = new H04FamilyViewChildDevAccHistoryFragment();
