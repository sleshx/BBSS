 ...
 * Created by chuanhe
 */
public class AiLocatorActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        faqWebView.loadUrl(BabyBonusConstants.AI_LOCATOR_URL);
    ...
    private void setTitleBar() {
        ...
        tvPageTitle.setText(R.string.title_activity_ai_locator);
        ...
        ivBackButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(AiLocatorActivity.this, MainActivity.class));
                finish();
            }
        });
    }
