 ...
 * Created by bandaray
 */
public class ChangeNahFragmentContainerActivity extends FragmentActivity {
    ...
    private List<Fragment> getWizardPages() {
        ...
        fragments.add(S01ChangeNahChildListFragment.newInstance(0));
        fragments.add(S02ChangeNahTypeSelectionFragment.newInstance(1));
        fragments.add(S03ChangeNahPersonParticularsFragment.newInstance(2));
        fragments.add(S04ChangeNahPersonAddressFragment.newInstance(3));
        fragments.add(S05ChangeNahBankDeclarationFragment.newInstance(4));
        return fragments;
    }
    ...
    public void setFragmentTitle(View rootView) {
        helper.setFragmentTitle(rootView, R.string.title_activity_services_change_nah);
    }
    ...
    public void setInstructions(View rootView, int currentPageNo, int descriptionStringId,
        ...
        helper.setFragmentInstructions(rootView, currentPageNo,
                R.string.desc_services_change_nah_instruction_title, descriptionStringId,
