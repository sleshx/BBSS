 ...
 */
public class S01ChangeCdabChildListFragment extends Fragment implements FragmentWizard {
     ...
     */
    public static S01ChangeCdabChildListFragment newInstance(int index) {
        S01ChangeCdabChildListFragment fragment = new S01ChangeCdabChildListFragment();
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        adapter = new SelectChildArrayAdapter(context, childItems, ChildListType.CHANGE_CDAB);
    ...
    private void setSelectedChildList() {
        ...
        ServiceChangeCdab changeCdab = app.getServiceChangeCdab();
        if (changeCdab != null) {
            changeCdab.setChildItems(selectedChildList);
            changeCdab.setChildIds(selectedChildIdList);
        }
        ...
        app.setServiceChangeCdab(new ServiceChangeCdab(selectedChildList, selectedChildIdList));
    }
    ...
    private void executeGetChildListAsyncTask() {
        ...
        ServicesGetChildListItemsTask asyncTask = new ServicesGetChildListItemsTask(
                context, ServiceAppType.CHANGE_CDAB,
