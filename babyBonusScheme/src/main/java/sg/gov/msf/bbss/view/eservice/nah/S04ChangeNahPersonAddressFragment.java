 ...
 * Created by bandaray
 */
public class S04ChangeNahPersonAddressFragment extends Fragment implements FragmentWizard {
     ...
     */
    public static S04ChangeNahPersonAddressFragment newInstance(int index) {
        S04ChangeNahPersonAddressFragment fragment = new S04ChangeNahPersonAddressFragment();
    ...
    public boolean onPauseFragment(boolean isValidationRequired) {
        ...
        serviceChangeNah.getNominatedAccHolder().setPostalAddress(address);
        serviceChangeNah.clearClientPageValidations(CURRENT_POSITION);
        serviceChangeNah.addSectionPage(SerializedNames.SEC_ADDRESS, CURRENT_POSITION);
    ...
    public boolean onResumeFragment() {
        isAddressLocal = app.getServiceChangeNah().getNominatedAccHolder().getAddressType().equals(
                AddressType.LOCAL);
    ...
    private void displayData(String errorMessage) {
        ServiceChangeNah serviceChangeNah = app.getServiceChangeNah();
        Address address = serviceChangeNah.getNominatedAccHolder().getPostalAddress();
    ...
    private class FetchAddressFromPostalCodeClickListener implements View.OnClickListener {
