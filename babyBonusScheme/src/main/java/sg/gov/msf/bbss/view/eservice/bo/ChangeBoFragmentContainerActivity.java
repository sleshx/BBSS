 ...
 */
public class ChangeBoFragmentContainerActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        app.setServiceChangeBo(new ServiceChangeBo());
    ...
    private List<Fragment> getFamilyViewWizardPages() {
        ...
        fragments.add(S01ChangeBoDescriptionFragment.newInstance(0));
        fragments.add(S02ChangeBoChildListFragment.newInstance(1));
        fragments.add(S03ChangeBoDeclarationFragment.newInstance(2));
    ...
    public void setFragmentTitle(View rootView) {
        helper.setFragmentTitle(rootView, R.string.title_activity_services_change_bo);
    }
    ...
    public void setInstructions(View rootView, int currentPageNo, int descriptionStringId,
        ...
        helper.setFragmentInstructions(rootView, currentPageNo,
                R.string.desc_services_change_bo_instruction_title, descriptionStringId,
