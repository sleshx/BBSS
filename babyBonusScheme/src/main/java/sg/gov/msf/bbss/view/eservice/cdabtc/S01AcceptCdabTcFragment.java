 ...
 */
public class S01AcceptCdabTcFragment extends Fragment implements FragmentWizard {
    ...
    public static S01AcceptCdabTcFragment newInstance(int index) {
        S01AcceptCdabTcFragment fragment = new S01AcceptCdabTcFragment();
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        adapter = new SelectChildArrayAdapter(context, childItems, ChildListType.TERMS_AND_COND);
    ...
    private void displayData() {
        ...
        fragmentContainer.setInstructions(listHeaderView, CURRENT_POSITION,
                R.string.desc_services_accept_cdab_tc_instruction_decs, false,
    ...
    private void setSelectedChildList() {
        ...
        ServiceCdabTc changeCDATC = app.getServiceCdabTc();
        if (changeCDATC != null) {
            changeCDATC.setChildItems(selectedChildList);
            changeCDATC.setChildIds(selectedChildIdList);
        }
        ...
        app.setServiceCdabTc(new ServiceCdabTc(selectedChildList, selectedChildIdList));
    }
    ...
    private void executeGetChildListAsyncTask() {
        ...
        ServicesGetChildListItemsTask asyncTask = new ServicesGetChildListItemsTask(
                context, ServiceAppType.TERMS_AND_COND,
