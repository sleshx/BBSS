 ...
 */
public class S01ChangeNanChildListFragment extends Fragment implements FragmentWizard {
     ...
     */
    public static S01ChangeNanChildListFragment newInstance(int index) {
        S01ChangeNanChildListFragment fragment = new S01ChangeNanChildListFragment();
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        adapter = new SelectChildArrayAdapter(context, childItems, ChildListType.CHANGE_NAN);
    ...
    private void displayData() {
        ...
        fragmentContainer.setInstructions(listHeaderView, CURRENT_POSITION,
                R.string.desc_services_common_child_list_instruction_desc, false,
    ...
    private void setSelectedChildList() {
        ...
        ServiceChangeNan changeNan = app.getServiceChangeNan();
        if (changeNan != null) {
            changeNan.setChildItems(selectedChildList);
            changeNan.setChildIds(selectedChildIdList);
        }
        ...
        app.setServiceChangeNan(new ServiceChangeNan(selectedChildList, selectedChildIdList));
    }
    ...
    private void executeGetChildListAsyncTask() {
        ...
        ServicesGetChildListItemsTask asyncTask = new ServicesGetChildListItemsTask(
                context, ServiceAppType.CHANGE_NAN,
