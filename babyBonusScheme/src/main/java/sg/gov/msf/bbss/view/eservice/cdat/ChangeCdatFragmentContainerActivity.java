 ...
 */
public class ChangeCdatFragmentContainerActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        app.setServiceChangeCdat(new ServiceChangeCdat());
    ...
    private List<Fragment> getWizardPages() {
        ...
        fragments.add(S01ChangeCdatChildListFragment.newInstance(0));
        fragments.add(S02ChangeCdatTypeSelectionFragment.newInstance(1));
        fragments.add(S03ChangeCdatPersonParticularsFragment.newInstance(2));
        fragments.add(S04ChangeCdatPersonAddressFragment.newInstance(3));
        fragments.add(S05ChangeCdatDeclarationFragment.newInstance(4));
        return fragments;
    }
    ...
    public void setFragmentTitle(View rootView) {
        helper.setFragmentTitle(rootView, R.string.title_activity_services_change_cdat);
    }
    ...
    public void setInstructions(View rootView, int currentPageNo, int descriptionStringId,
        ...
        helper.setFragmentInstructions(rootView, currentPageNo,
                R.string.desc_services_change_cdat_instruction_title, descriptionStringId,
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!current.onPauseFragment(isValidationRequired)) {
                    ...
                    if (currentPosition == 4 && !app.getServiceChangeCdat().isThirdParty()) {
        ...
        nextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!current.onPauseFragment(isValidationRequired)) {
                    ...
                    if (currentPosition == 1 && !app.getServiceChangeCdat().isThirdParty()) {
                        jumpToPageWithIndex(currentPosition + 3);
                    } else {
                        jumpToPageWithIndex(currentPosition + 1);
                    }
